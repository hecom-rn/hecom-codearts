...
// detail 实现已迁移至 issue.command，此处保留别名供 story detail 子命令使用
export { issueDetailCommand as storyDetailCommand } from './issue.command';
export type {
  IssueDetailAttachment as StoryDetailAttachment,
  IssueDetailImage as StoryDetailImage,
  IssueDetailResult as StoryDetailResult,
} from './issue.command';
